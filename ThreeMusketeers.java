...
public class ThreeMusketeers {
    ...
    protected void move(final Agent agent) { // TODO
    	Move newMove = agent.getMove();//ask current agent for move
    	moves.add(newMove);            //execute move
    	board.move(newMove);           //add move to stack
    }
    ...
    private void undoMove() { // TODO
    	Move move = moves.remove(moves.size() - 1);//remove move at top of the stack
